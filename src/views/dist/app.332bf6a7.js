...
function (_React$Component) {
  _inherits(Formm, _React$Component);
  ...
  function Formm() {
    ...
    var pes = [{}];
    fetch("http://localhost:3000/profile").then(function (data) {
      return data.json();
    }).then(function (resp) {
      console.log('response', resp);
      window.dar = resp;
      resp.post.map(function (item, i) {
        console.log('item.images.thumbnail.url', item.images.thumbnail.url);
  ...
  _createClass(Formm, [{
    ...
    value: function render() {
      ...
      this.state.img.map(function (item, i) {
...
_reactDom.default.render(_react.default.createElement(Formm, null), document.getElementById('root'));
...
//# sourceMappingURL=/app.332bf6a7.map